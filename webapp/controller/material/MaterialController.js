sap.ui.define([
	...
	return {
		...
		initializeUnitComboBox : function(oComboBox, oResourceBundle) {
			MainController.addItemToComboBox(oComboBox, oResourceBundle, "ST", "unit.st");
			MainController.addItemToComboBox(oComboBox, oResourceBundle, "L", "unit.l");
			MainController.addItemToComboBox(oComboBox, oResourceBundle, "KG", "unit.kg");
			MainController.addItemToComboBox(oComboBox, oResourceBundle, "T", "unit.t");
		},
